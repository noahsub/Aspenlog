...
def process_roof_load_combination_data(
    building: Building,
    snow_load_upwind: SnowLoad,
    snow_load_downwind: SnowLoad,
    uls_roof_type: str,
    sls_roof_type: str,
):
    """
    ...
    upwind_roof_combination = compute_roof_load_combinations(
        building, snow_load_upwind, uls_wall_type, sls_wall_type
    )
    downwind_roof_combination = compute_roof_load_combinations(
        building, snow_load_downwind, uls_wall_type, sls_wall_type
    )
