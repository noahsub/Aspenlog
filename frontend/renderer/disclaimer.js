document.getElementById('accept-button').addEventListener('click', function (event) {
    ...
    if (disclaimerScroll.scrollTop + disclaimerScroll.clientHeight !== disclaimerScroll.scrollHeight) {
        alert('Please scroll to the bottom before accepting to ensure you have read the entire contents.');
        return;
    }
