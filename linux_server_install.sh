...
# Populate database
python3.11 -m database/Population/populate_authentication_data.py
python3.11 -m database/Population/populate_canadian_postal_code_data.py
python3.11 -m database/Population/populate_climate_data.py
python3.11 -m database/Population/populate_save_data.py
python3.11 -m database/Population/populate_wind_speed_data.py
deactivate