...
def create_cube(length=2.0, width=2.0, height=2.0):
    ...
    length = 2.0 # 90% of this value for the rectangular prism
    width = 2.0
    height = 2.0
...
def main():
    ...
    bpy.context.scene.render.filepath = "/Users/Alastair/Dev/SEEDA/blender/output/test.png"
    ...
    #render.setup_scene()
    #render.render_image(os.environ['BLENDER_OUTPUT'])
